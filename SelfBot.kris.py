...
cl = LINETCR.LINE() 
#cl.login(qr=True)
cl.login(token="")#Akun yg kita pakai
cl.loginResult()

ki = LINETCR.LINE() 
#ki.login(qr=True)
ki.login(token="")#Assist/akun bot 1
ki.loginResult()

kk = LINETCR.LINE() 
#kk.login(qr=True)
kk.login(token="")#Assist/akun bot 2
kk.loginResult()

kc = LINETCR.LINE() 
#kc.login(qr=True)
kc.login(token="")#Assist/akun bot 3
kc.loginResult()

ks = LINETCR.LINE() 
#ks.login(qr=True)
ks.login(token="")#Assist/akun bot 4
ks.loginResult() 

k1 = LINETCR.LINE() 
k1.login(token="")#Assist/akun bot 5
#k1.login(qr=True)
k1.loginResult() 

satpam = LINETCR.LINE() 
satpam.login(token="")#Akun satpam/bot fungsinya untuk menendang target dan left lagi
...
autoleaveroom = []
targets = []
Bots=[mid,Amid,Bmid,Cmid,Dmid,Umid]
induk=[mid]
utama=[Umid]
admin=["u31ef22df7f538df1d74dc7f756ef1a32",mid,Amid,Bmid,Cmid,Dmid,Umid] #Krisna,kris,
...
#--------------------------------
        ...
        if op.type == 24:
            if wait["leaveRoom"] == True:
                cl.leaveRoom(op.param1)
        if op.type == 25: #awalnya 26,, utk selfbot jd 25
            msg = op.message
            if msg.toType == 1:
                if wait["leaveRoom"] == True:
                    cl.leaveRoom(msg.to)
             ...
             if op.param2 in admin or Bots:
              ...
              if msg.from_ in mid or admin:
                if wait["lang"] == "JP":
                    ...
                    cl.sendText(msg.to,"Gunakan dengan bijak ...!!!")
                else:
...
#==========================================================================	
              ...
              if msg.from_ in mid or admin:
                ...
                for i in gid:
                    random.choice(KAC).rejectGroupInvitation(i)
                if wait["lang"] == "JP":
                    random.choice(KAC).sendText(msg.to,"All Invites has been Rejected")
                else:
                    random.choice(KAC).sendText(msg.to,"拒绝了全部的邀请。")
                if wait["Protectgr"] == True:
                    if wait["lang"] == "JP":
                        random.choice(KAC).sendText(msg.to,"Protect QR On")
                    else:
                ...
                if wait["Protectcancl"] == True:
                    if wait["lang"] == "JP":
                        random.choice(KAC).sendText(msg.to,"Cancel Semua Undangan On")
                    else:
                        random.choice(KAC).sendText(msg.to,"done")
                else:
                ...
                if wait["Protectjoin"] == True:
                    if wait["lang"] == "JP":
                        random.choice(KAC).sendText(msg.to,"Kick Joined Group On")
                    else:
                        random.choice(KAC).sendText(msg.to,"Done")
                else:
                ...
                if wait["protectionOn"] == True:
                    if wait["lang"] == "JP":
                        random.choice(KAC).sendText(msg.to,"turned into high protection\n\n"+ datetime.today().strftime('%H:%M:%S'))
                    else:
                        random.choice(KAC).sendText(msg.to,"turned into high protection\n\n"+ datetime.today().strftime('%H:%M:%S'))
                else:
                ...
                if wait["qr"] == True:
                    if wait["lang"] == "JP":
                        random.choice(KAC).sendText(msg.to,"Already on\n\n"+ datetime.today().strftime('%H:%M:%S'))
                    else:
                        random.choice(KAC).sendText(msg.to,"Protection QR PRO On\n\n"+ datetime.today().strftime('%H:%M:%S'))
                else:
                    wait["qr"] = True
                    if wait["lang"] == "JP":
                        random.choice(KAC).sendText(msg.to,"Protection QR PRO On\n\n"+ datetime.today().strftime('%H:%M:%S'))
                ...
                if msg.to in wait['pname']:
                    random.choice(KAC).sendText(msg.to,"ƬƲƦƝЄƊ ƠƝ.")
                else:
                    random.choice(KAC).sendText(msg.to,"ƛԼƦЄƛƊƳ ƠƝ")
                    wait['pname'][msg.to] = True
                    wait['pname'][msg.to] = cl.getGroup(msg.to).name
              if msg.from_ in mid or admin:
				gid = msg.to
				autocancel[gid] = "poni"
				random.choice(KAC).sendText(msg.to,"ƤƦƠƬЄƇƬ ƖƝƔƖƬƛƬƖƠƝ ƠƝ")
				if msg.to in protection:
					random.choice(KAC).sendText(msg.to,"ᴀʟʀᴇᴀᴅʏ Protect ᴏɴ")
				else:
					...
					random.choice(KAC).sendText(msg.to,"Protect ᴛᴜʀɴᴇᴅ ᴏɴ")
              if msg.from_ in mid or admin:
                if wait["Protectcancel"] == True:
                    if wait["lang"] == "JP":
                        random.choice(KAC).sendText(msg.to,"Yang Cancel Undangan Kami Kick")
                    else:
                        random.choice(KAC).sendText(msg.to,"done")
                else:
...
#==========================================================================	
              ...
              if msg.from_ in mid or admin:
                if wait["Protectgr"] == False:
                    if wait["lang"] == "JP":
                        random.choice(KAC).sendText(msg.to,"Protect QR Off")
                    else:
                        random.choice(KAC).sendText(msg.to,"done")
                else:
                ...
                if wait["Protectcancl"] == False:
                    if wait["lang"] == "JP":
                        random.choice(KAC).sendText(msg.to,"Cancel Semua Undangan Off")
                    else:
                        random.choice(KAC).sendText(msg.to,"done")
                else:
                ...
                if wait["Protectjoin"] == False:
                    if wait["lang"] == "JP":
                        random.choice(KAC).sendText(msg.to,"kick Joined Group Off")
                    else:
                        random.choice(KAC).sendText(msg.to,"done")
                else:
                ...
                if wait["qr"] == False:
                    if wait["lang"] == "JP":
                        random.choice(KAC).sendText(msg.to,"Already off\n\n"+ datetime.today().strftime('%H:%M:%S'))
                    else:
                        random.choice(KAC).sendText(msg.to,"Protection QR PRO Off\n\n"+ datetime.today().strftime('%H:%M:%S'))
                else:
                    wait["qr"] = False
                    if wait["lang"] == "JP":
                        random.choice(KAC).sendText(msg.to,"Protection QR PRO Off\n\n"+ datetime.today().strftime('%H:%M:%S'))
                ...
                if wait["protectionOn"] == False:
                    if wait["lang"] == "JP":
                        random.choice(KAC).sendText(msg.to,"turned into low protection\n\n"+ datetime.today().strftime('%H:%M:%S'))
                    else:
                        random.choice(KAC).sendText(msg.to,"turned into low protection\n\n"+ datetime.today().strftime('%H:%M:%S'))
                else:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        random.choice(KAC).sendText(msg.to,"turned into low protection\n\n"+ datetime.today().strftime('%H:%M:%S'))
                if msg.to in wait['pname']:
                    random.choice(KAC).sendText(msg.to,"ƬƲƦƝ ƠƑƑ.")
                    del wait['pname'][msg.to]
                else:
                    random.choice(KAC).sendText(msg.to,"ƛԼƦЄƛƊƳ ƠƑƑ")
                if wait["Protectcancel"] == False:
                    if wait["lang"] == "JP":
                        random.choice(KAC).sendText(msg.to,"Yang Cancel Undangan Tidak Kami Kick")
                    else:
                        random.choice(KAC).sendText(msg.to,"done")
                else:
            ...
            if "Mode off" == msg.text:
              if msg.from_ in mid or admin:
				try:
					...
					random.choice(KAC).sendText(msg.to,"ƤƦƠƬЄƇƬ ƖƝƔƖƬƛƬƖƠƝ ƠƑƑ")
				except:
					pass
            ...
            if "Mode off" == msg.text:
				try:
					if msg.from_ in mid or admin:
						...
						random.choice(KAC).sendText(msg.to,"Protect ᴛᴜʀɴᴇᴅ ᴏғғ")
					else:
						random.choice(KAC).sendText(msg.to,"Not have Access Protect")
				except:
					pass
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["One piece","Kr asup","Ah"]: #Panggil Semua Bot
              if msg.from_ in mid or admin:
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Kabur all","Mantog"]: #Bot Ninggalin Group termasuk Bot Induk
              if msg.from_ in mid or admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
            ...
            elif msg.text in ["Kabur","Uh"]: #Semua Bot Ninggalin Group Kecuali Bot Induk
              if msg.from_ in mid or admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
    ...
    #-------------Fungsi Tag All Finish---------------#
        ...
        #----------------Fungsi Banned Kick Target Finish----------------------#                
            ...
            elif "Ready op" in msg.text:#menghapus semua sama botnya
              if msg.from_ in mid or admin:
                if msg.toType == 2:
                    print "ok"
            ...
            elif "Greet" in msg.text:#mnhapus semua kecuali bot
              if msg.from_ in mid or admin:
                if msg.toType == 2:
                    print "ok"
              ...
              if msg.from_ in mid or admin:
                ...
                if msg.toType == 2:
                    ...
                    gs = k1.getGroup(msg.to)
                    ki.sendText(msg.to,"maaf kalo gak sopan")
                    kk.sendText(msg.to,"Qo salamnya gak ada yang jawab ya..!!")
                    kc.sendText(msg.to,"hehehhehe")
                    msg.contentType = 13
                    msg.contentMetadata = {'mid': mid}
                    ks.sendMessage(msg)
